...
class TestSearchEpgChannels:
    ...
    @pytest.mark.parametrize("detail,expected", [
        ...
        ("EPG catalogue request failed: Catalogue source counts are unavailable.",
         "HTTP status 500. Catalogue error: Catalogue source counts are unavailable."),
        ("EPG catalogue request failed: Catalogue source counts are unavailable. https://guide.invalid/?key=private",
         "HTTP status 500."),
